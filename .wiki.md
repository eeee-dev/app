# Project Summary
The Financial Management Dashboard for the ë Ecosystem is a robust platform designed for businesses to optimize their financial operations. It offers functionalities for budget management, expense tracking, income reporting, and invoice processing, ensuring compliance with regulations such as Mauritius VAT. By utilizing automation and data analytics, the dashboard improves operational efficiency and supports informed financial decision-making. Recent updates include the implementation of a comprehensive Income Category Breakdown System, which enhances the categorization and management of income streams.
...
- **cleanup-income-categories.sql**: Script to clean up existing income category tables and functions before migration.
