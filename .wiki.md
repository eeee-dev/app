# Project Summary
The Financial Management Dashboard for the ë Ecosystem is a comprehensive platform aimed at enhancing financial operations for businesses. It facilitates budget management, expense tracking, income reporting, and invoice processing, ensuring compliance with regulations like Mauritius VAT. By leveraging automation and data analytics, the dashboard fosters operational efficiency and informed decision-making. The latest enhancement includes a sophisticated Income Category Breakdown System, allowing users to manage income streams more effectively.

# Project Module Description
- **Dashboard**: Displays essential financial metrics and user activities, integrated with Supabase data.
- **Expenses**: Manages expenses with CRUD operations and VAT calculations; includes optional department and project fields.
- **Income**: Tracks income through manual entries and invoice management, featuring category breakdowns.
