# Project Summary
The Financial Management Dashboard for the ë Ecosystem is an innovative platform designed to optimize financial operations for businesses. It provides tools for budget management, expense tracking, income reporting, and invoice processing, ensuring compliance with regulations such as Mauritius VAT. The dashboard leverages automation and advanced analytics to enhance operational efficiency and empower users to make informed financial decisions, while prioritizing accessibility and ease of deployment. The recent updates introduce a flexible project-department structure, allowing for more nuanced financial management.

# Project Module Description
- **Dashboard**: Displays key financial metrics and user activities, now connected to real Supabase data.
- **Expenses**: Manages expenses with CRUD operations and VAT calculations; department and project fields are now optional.
- **Income**: Tracks income through manual entries and invoice management, fully functional with Supabase; both department and project fields are optional.
...
- **Settings**: Configuration options for user preferences and notifications, partially functional with team management needing Edge Function.
...
- **Statistics**: Displays comprehensive financial analytics including revenue and expense trends, budget utilization, and department performance, now fully functional with real Supabase data.
...
- **Migration**: New migration script for adding project-department relationships and fixing schema issues.
...
│   ├── migration-project-departments.sql # New migration for project-department relationships
...
- **supabase-migrations/**: Contains SQL migration scripts for database changes, including the new project-department migration.
- **setup-database-manual.sql**: SQL script for manual database setup.
