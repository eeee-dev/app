# Project Summary
The Financial Management Dashboard for the ë Ecosystem is a comprehensive platform designed to streamline financial operations for businesses. It provides tools for budget management, expense tracking, income reporting, and invoice processing, ensuring adherence to regulations such as Mauritius VAT. By leveraging automation and data analytics, the platform enhances operational efficiency and supports informed decision-making. Recent enhancements have focused on implementing real-time data synchronization and bulk deletion for Income, Expenses, and Purchase Orders pages, significantly improving user experience.

# Project Module Description
- **Dashboard**: Displays key financial metrics and user activities, integrated with Supabase data.
- **Expenses**: Manages expenses with CRUD operations and VAT calculations; includes optional department and project fields. Now features real-time sync and bulk delete capabilities.
- **Income**: Tracks income through manual entries and invoice management, featuring category breakdowns. Now includes real-time sync and bulk delete functionality.
