-- ë Finance Dashboard - Complete Database Setup Script
-- Run this script in your Supabase SQL Editor (https://supabase.com/dashboard/project/ssekkfxkigyavgljszpc/sql/new)
