-- Finance Dashboard - Final Database Setup
...
CREATE TABLE app_72505145eb_enhanced_income (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id UUID REFERENCES auth.users NOT NULL,
...
CREATE TABLE app_72505145eb_expenses (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id UUID REFERENCES auth.users NOT NULL,
...
CREATE TABLE app_72505145eb_purchase_orders (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id UUID REFERENCES auth.users NOT NULL,
...
-- Create indexes
CREATE INDEX idx_projects_department ON app_72505145eb_projects(department_id);
CREATE INDEX idx_enhanced_income_user ON app_72505145eb_enhanced_income(user_id);
CREATE INDEX idx_expenses_user ON app_72505145eb_expenses(user_id);
CREATE INDEX idx_expenses_department ON app_72505145eb_expenses(department_id);
